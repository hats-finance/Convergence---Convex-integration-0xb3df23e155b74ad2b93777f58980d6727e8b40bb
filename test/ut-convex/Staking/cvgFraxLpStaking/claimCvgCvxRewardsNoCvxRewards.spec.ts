...
describe("cvgFraxLpStaking - Claim CvgCvx Rewards without Cvx rewards", () => {
    ...
    before(async () => {
        ...
        await cvgeUSDFRAXBPStaking.connect(user3).deposit(MINT, depositedAmountUser2);
        await cvgeUSDFRAXBPStaking.connect(user3).withdraw(3, depositedAmountUser2);
    });
