...
describe("SdtStaking - Claim  CvgSdt after a cycle triggered for CVG without processing SDT Two.", () => {
    ...
    it("Succees : claimCvgSdt for cycle 2", async () => {
        ...
        expect(await sdCRVStaking.nextClaims(TOKEN_4)).to.be.deep.eq([CYCLE_3, CYCLE_2]);
    });
