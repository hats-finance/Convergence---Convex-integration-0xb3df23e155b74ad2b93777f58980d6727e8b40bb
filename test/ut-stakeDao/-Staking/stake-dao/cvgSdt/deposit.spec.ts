...
describe("CvgSdtStaking - Deposit", () => {
    ...
    it("Success : Update staking cycle to 2 and processRewards CVG", async () => {
        ...
        expect(await cvgSdtStakingContract.cycleInfo(CYCLE_2)).to.be.deep.eq([0, expectedAmount, false]);
    });
    ...
    it("Success : Updating staking cycle to 3 and processRewards", async () => {
        ...
        expect(await cvgSdtStakingContract.cycleInfo(CYCLE_3)).to.be.deep.eq([0, expectedAmount, false]);
    });
