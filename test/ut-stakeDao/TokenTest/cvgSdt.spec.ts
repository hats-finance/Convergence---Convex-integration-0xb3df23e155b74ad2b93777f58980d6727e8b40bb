...
import {deploySdtStakingFixture, deployYsDistributorFixture, increaseCvgCycle} from "../../fixtures/stake-dao";
...
describe("CvgSdt Token Tests", () => {
    let ysdistributor: YsDistributor, treasuryDao: Signer;
    let dai: ERC20, weth: ERC20, crv: ERC20, usdc: ERC20, sdt: ERC20;
    let owner: Signer, user1: Signer, user2: Signer;
    let lockingPositionServiceContract: LockingPositionService, cvgContract: Cvg, cvgSdt: CvgSDT, cvgControlTower: CvgControlTower;
