...
import {deployPresaleVestingFixture} from "../../fixtures/stake-dao";
...
import {TREASURY_CORE} from "../../../resources/treasury";
...
describe("Vesting Team/Dao Cvg / Release tests", () => {
    ...
    it("Success close the sale state of both WL & Presale", async () => {
        ...
        await presaleContractSeed.connect(await ethers.getSigner(TREASURY_CORE)).setSaleState(3);
        await network.provider.request({
    ...
    it("release daysBeforeCliff for DAO should compute right infos", async () => {
        ...
        expect(await cvg.balanceOf(DAO)).to.be.approximately("712500000000000000000000", ethers.parseEther("3"));
    });
    ...
    it("Go to day 10", async () => {
        ...
        await vestingContract.connect(DAO).releaseTeamOrDao(false);
        expect(await cvg.balanceOf(DAO)).to.be.approximately("963197347987500000000000", ethers.parseEther("2"));
    });
    it("Go to day 20", async () => {
        ...
        await vestingContract.connect(DAO).releaseTeamOrDao(false);
        expect(await cvg.balanceOf(DAO)).to.be.approximately("1213892381062500000000000", ethers.parseEther("2"));
    });
    ...
    it("Go to day 30", async () => {
        ...
        await vestingContract.connect(DAO).releaseTeamOrDao(false);
        expect(await cvg.balanceOf(DAO)).to.be.approximately("1464587400600000000000000", ethers.parseEther("1"));
    });
    ...
    it("Go to day 90", async () => {
        ...
        await vestingContract.connect(DAO).releaseTeamOrDao(false);
        expect(await cvg.balanceOf(DAO)).to.be.approximately("2968754647875000000000000", ethers.parseEther("1"));
    });
    ...
    it("Go to day 179", async () => {
        ...
        await vestingContract.connect(DAO).releaseTeamOrDao(false);
        expect(await cvg.balanceOf(DAO)).to.be.approximately("5199935788050000000000000", ethers.parseEther("1"));
    });
    ...
    it("Go to day 180, unlock cliff TEAM", async () => {
        ...
        await vestingContract.connect(DAO).releaseTeamOrDao(false);
        expect(await cvg.balanceOf(DAO)).to.be.approximately("5225006100900000000000000", ethers.parseEther("1"));
    });
    ...
    it("Go to day 300 => 6 months after DAO cliff & 4 months after cliff TEAM", async () => {
        ...
        await vestingContract.connect(DAO).releaseTeamOrDao(false);
        expect(await cvg.balanceOf(DAO)).to.be.approximately("8233339729050000000000000", ethers.parseEther("1"));
    });
    ...
    it("Go to day 480 => 12 months after DAO cliff & 10 months after cliff TEAM", async () => {
        ...
        await vestingContract.connect(DAO).releaseTeamOrDao(false);
        expect(await cvg.balanceOf(DAO)).to.be.approximately("12745840306650000000000000", ethers.parseEther("1"));
    });
    ...
    it("Go to day 540 => 14 months after DAO cliff & 12 months after cliff TEAM", async () => {
        ...
        await vestingContract.connect(DAO).releaseTeamOrDao(false);
        expect(await cvg.balanceOf(DAO)).to.be.equal("14250000000000000000000000");
    });
    ...
    it("Go to day 720 => end of both vesting", async () => {
        ...
        await vestingContract.connect(TEAM).releaseTeamOrDao(true);
        expect(await cvg.balanceOf(DAO)).to.be.eq("14250000000000000000000000");
