...
describe("Presale Wl", () => {
    ...
    it("invest with user 7 before start of presale should revert", async () => {
        const merkleProof7 = MerkleHelper.getProofMerkle(wlAddressesS, await user7.getAddress());
    ...
    it("invest with user 7 with wrong proof should revert", async () => {
        const merkleProof7 = MerkleHelper.getProofMerkle(wlAddressesS, await user8.getAddress());
