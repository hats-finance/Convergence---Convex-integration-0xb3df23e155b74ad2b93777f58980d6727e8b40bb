...
import {CYCLE_5, TOKEN_1} from "../../../resources/constant";
...
describe("LockingPositionManager  / timelocking", () => {
    ...
    it("Fail : Redeeming a bond when timelocked", async () => {
        await expect(ysdistributor.connect(user1).claimRewards(TOKEN_1, 1, user1)).to.be.revertedWith("TOKEN_TIMELOCKED");
    });
