...
describe("Coverage ControlTower ", () => {
    ...
    it("Fail: setTreasuryPod with random user", async () => {
        await cvgControlTower.setTreasuryPod(user1).should.be.revertedWith("Ownable: caller is not the owner");
    });
    it("Fail: setTreasuryPdd with random user", async () => {
        await cvgControlTower.setTreasuryPdd(user1).should.be.revertedWith("Ownable: caller is not the owner");
    });
    ...
    it("Fail: setTreasuryTeam with random user", async () => {
        await cvgControlTower.setTreasuryTeam(user1).should.be.revertedWith("Ownable: caller is not the owner");
    });
    ...
    it("Fail: setBondDepository with random user", async () => {
        await cvgControlTower.setBondDepository(user1).should.be.revertedWith("Ownable: caller is not the owner");
    });
