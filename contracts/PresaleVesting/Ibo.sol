...
contract Ibo is ERC721Enumerable, Ownable2Step {
     ...
     */
    function setComposedFunction(uint256 bondId, IBondStruct.BondFunction newComposedFunction) external onlyOwner {
        require(newComposedFunction <= IBondStruct.BondFunction.LINEAR, "INVALID_COMPOSED_FUNCTION");
    ...
    function deposit(
        ...
        uint256 _totalCvgDue = totalCvgDuePerBond[bondId];
        {
            ...
            depositedUsdValue =
                amountIn *
                cvgOracle.getPriceVerified(address(_bondParams.token)) *
