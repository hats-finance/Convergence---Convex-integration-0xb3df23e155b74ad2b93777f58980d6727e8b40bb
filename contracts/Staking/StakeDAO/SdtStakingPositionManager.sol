...
contract SdtStakingPositionManager is CvgERC721TimeLockingUpgradeable {
    ...
    /**
     * @notice Verifies that the input of the claimMultiple on the SdtRewardDistributor is correct.
     ...
     */
    function setLogo(ISdtStakingLogo _logo) external onlyOwner {
        logo = _logo;
    }
